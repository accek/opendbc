...
# acspilot: MQB carcontroller forwards stock messages with modified fields rather than packing them
# from scratch. The create_* hooks below take/return a `values` dict (the decoded stock message), so
# the carcontroller's forward_message() can preserve unmodified signals. MSG_* name the forwarded
# messages and the bus each is rewritten onto.
MSG_STEERING = "HCA_01"
MSG_EPS = "LH_EPS_03"
MSG_LKA_HUD = "LDW_02"
