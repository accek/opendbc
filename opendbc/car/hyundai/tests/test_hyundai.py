...
class TestHyundaiFingerprint(unittest.TestCase):
  def test_feature_detection(self):
    ...
    for lka_steering in (True, False):
      ...
      CP = CarInterface.get_params(CAR.KIA_EV6, fingerprint, [], False, False, False, False)
    ...
    for radar in (True, False):
      ...
      CP = CarInterface.get_params(CAR.HYUNDAI_SONATA, fingerprint, [], False, False, False, False)
  ...
  def test_alternate_limits(self):
    ...
    for car_model in CAR:
      CP = CarInterface.get_params(car_model, fingerprint, [], False, False, False, False)
